...
// Direct measurements of Espdrone position
...
// Direct measurements of Espdrone pose
...
void estimatorKalmanTaskInit() {
  ...
  STATIC_MEM_TASK_CREATE_CORE_1(kalmanTask, kalmanTask, KALMAN_TASK_NAME, NULL, KALMAN_TASK_PRI);
