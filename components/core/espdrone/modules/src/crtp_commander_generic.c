...
/* velocityDecoder
 * Set the Espdrone velocity in the world coordinate system
 */
...
/* zDistanceDecoder
 * Set the Espdrone absolute height and roll/pitch angles
 */
...
/* altHoldDecoder
 * Set the Espdrone vertical velocity and roll/pitch angle
 */
...
/* hoverDecoder
 * Set the Espdrone absolute height and velocity in the body coordinate system
 */
