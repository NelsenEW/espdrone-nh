...
/* LOG configurations. Enable these to be able to log detection in the edclient. */
...
/* PARAM configurations. Enable these to be able to tweak detection configurations from the edclient. */
